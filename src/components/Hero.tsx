      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-card border border-border mb-6">
            ...
            <span className="text-sm font-medium">Спортклуб №1 в Октябрьском</span>
          </div>
          
          {/* Main Title */}
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
            СПОРТКЛУБ<br />
            <span className="bg-gradient-hero bg-clip-text text-transparent">ОЛИМП</span>
          </h1>
          
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-2xl mx-auto">
            Кто здесь не был - тот будет!<br />
            А кто был - не забудет!
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col items-center p-4 rounded-lg bg-gradient-card border border-border shadow-card">
              ...
              <span className="text-sm text-muted-foreground">Опытных тренера</span>
            </div>
          </div>
        </div>
      </div>
