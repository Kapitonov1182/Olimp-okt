...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      action: () => window.open("https://maps.yandex.ru/?text=Октябрьский+ул.+Садовое+кольцо+40", "_blank")
    },
    {
      icon: MessageCircle,
      title: "Telegram",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Свяжитесь с нами для записи на тренировку или получения дополнительной информации
          </p>
        </div>
          ...
          <Card className="bg-gradient-button border-primary shadow-glow max-w-2xl mx-auto">
            <CardContent className="p-8">
              ...
              <p className="text-primary-foreground/90 mb-6">
                Позвоните нам прямо сейчас или приходите по адресу для консультации и записи
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  size="lg"
                  className="bg-background/20 border-background/30 text-primary-foreground hover:bg-background/30"
                  onClick={() => window.open("https://maps.yandex.ru/?text=Октябрьский+ул.+Садовое+кольцо+40", "_blank")}
                >
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-card border border-border">
